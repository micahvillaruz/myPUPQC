                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-3">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Enter your first name" value="Jaime" />
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-3">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="middle_name" name="middle_name" placeholder="Enter your middle name" value="P" />
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-3">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Enter your last name" value="Gutierrez" />
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-3">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="extension_name" name="extension_name" placeholder="Enter your extension name" value="Jr." />
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-4">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" data-provider="flatpickr" id="birth_date" name="birth_date" data-date-format="F j, Y" data-deafult-date="June 17, 1992" placeholder="Select date" />
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-4">
                      ...
                      <div class="col-lg-4">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="contact_number" name="contact_number" placeholder="Enter your Contact Number" value="09172910282" />
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="house_street" name="house_street" placeholder="Enter House No., Block, Street Name" value="PUP Quezon City Branch Don Fabian St.," />
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="barangay" name="barangay" placeholder="Enter Barangay" value="Commonwelath" />
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-4">
