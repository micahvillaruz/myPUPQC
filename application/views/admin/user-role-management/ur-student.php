<div class="row">
    <div class="card">
        <div class="card-header d-flex">
            <h5 class="card-title mb-0 flex-grow-1">Select Roles for Students</h5>
        </div>
        <div class="card-body justify-content-center text-center">
            ...
            <div class="row my-3 py-3">
                ...
                <select class="js-example-basic-multiple " multiple="multiple" name="select_student_roles" id="select_student_roles">
                </select>
                </div>
            </div>
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h5 class="card-title mb-0 flex-grow-1">Role Management for Students</h5>
        </div>
        <div class="card-body">
            <table id="students-with-roles" class="table table-bordered dt-responsive nowrap table-striped align-middle text-center w-100">
                <thead>
                    <tr>
                        <th>User Number</th>
                        <th>Full Name</th>
