...
<!-- autocomplete js -->
<script src="<?= base_url() ?>public/libs/@tarekraafat/autocomplete.js/autoComplete.min.js"></script>

<!-- init js -->
<script src="<?= base_url() ?>public/js/pages/form-advanced.init.js"></script>
