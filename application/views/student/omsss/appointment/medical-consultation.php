                    ...
                    <div class="row" id="appointment_form">
                        <div class="col-6">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control" oninput="setupInputRestriction(this)" id="consultation_reason" name="consultation_reason" style="resize:none" rows="8" required></textarea>
                            </div>
                        </div>
                        <div class="col-6">
