    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="javascript:void(0);" id="medicalHistoryForm">
                ...
                <h3 class="mb-3 text-primary">Social History</h3>
                <div class="mx-5">
                    <div class="row align-item-start">
                        <div class="col-6">
                ...
                <br>
                <h3 class="mb-3 text-primary">Allergy</h3>
                <div class="mx-4">
                    <div class="row align-item-start">
                        <div class="col-6">
        ...
        <div class="col-lg-7 mx-5">
            <div class="form-check">
                ...
                <label class="form-check-label" for="privacy">
                    By clicking the Submit button, I understood and agree to PUP Online Medical Service System's
