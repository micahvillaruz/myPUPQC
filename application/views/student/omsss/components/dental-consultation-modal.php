          ...
          <ul class="list list-group list-group-flush mb-0">
            ...
            <li class="list-group-item">
              <div class="d-flex align-items-center">
                ...
                <div class="col-8">
                  <div class="d-flex fs-13 fw-medium" id="view_reasonCon">Cleaning</div>
                </div>
              </div>
            </li>
            <!-- end list item -->
            <li class="list-group-item">
              <div class="d-flex align-items-center">
                ...
                <div class="col-8">
                  <div class="d-flex fs-13 fw-medium" id="view_dentist_name">Rosanna Florencia A. Ulep, DMD, MPH</div>
                </div>
              </div>
            </li>
            <!-- end list item -->
            <li class="list-group-item">
              <div class="d-flex align-items-center">
                ...
                <div class="col-8">
                  <div class="d-flex fs-13 fw-medium" id="view_date_created">18-09-2022</div>
                </div>
              </div>
            </li>
            <!-- end list item -->
            <li class="list-group-item">
              <div class="d-flex align-items-center">
                ...
                <div class="col-8">
                  <div class="d-flex fs-13 fw-medium" id="view_scheduled_date">20-09-2022</div>
                </div>
              </div>
            </li>
            <!-- end list item -->
