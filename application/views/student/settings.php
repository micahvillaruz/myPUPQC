                    ...
                    <div class="row">
                      <div class="text-center">
                        <div class="profile-user position-relative d-inline-block mx-auto mb-4">
                          <img src="<?= base_url() ?>public/images/profile/flat-faces-icons-circle-woman-6.png" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image" />
                      ...
                      <div class="col-lg-3">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Enter your first name" value="Micah" />
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-3">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="middle_name" name="middle_name" placeholder="Enter your middle name" value="Matorre" />
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-3">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Enter your last name" value="Villaruz" />
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-3">
                      ...
                      <div class="col-lg-4">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" data-provider="flatpickr" id="birth_date" name="birth_date" data-date-format="F j, Y" data-deafult-date="April 28, 2000" placeholder="Select date" />
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-4">
                      ...
                      <div class="col-lg-4">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="contact_number" name="contact_number" placeholder="Enter your Contact Number" value="09561437674" />
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="house_street" name="house_street" placeholder="Enter House No., Block, Street Name" value="Lot 21, Block 16, Molave Street" />
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="barangay" name="barangay" placeholder="Enter Barangay" value="Payatas B" />
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-4">
