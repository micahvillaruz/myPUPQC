        ...
        <div class="card">
          ...
          <div class="card-body pt-0">
                    ...
                    <div class="avatar-group">
                      <div class="avatar-group-item">
                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Stine Nielsen">
                          <img src="<?= base_url() ?>public/images/users/avatar-1.jpg" alt="" class="rounded-circle avatar-xxs">
                        </a>
                      </div>
                      <div class="avatar-group-item">
                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Jansh Brown">
                          <img src="<?= base_url() ?>public/images/users/avatar-2.jpg" alt="" class="rounded-circle avatar-xxs">
                        </a>
                      </div>
                      <div class="avatar-group-item">
                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Dan Gibson">
                          <img src="<?= base_url() ?>public/images/users/avatar-3.jpg" alt="" class="rounded-circle avatar-xxs">
                        </a>
                      </div>
                      <div class="avatar-group-item">
                    ...
                    <div class="avatar-group">
                      <div class="avatar-group-item">
                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Frida Bang">
                          <img src="<?= base_url() ?>public/images/users/avatar-4.jpg" alt="" class="rounded-circle avatar-xxs">
                        </a>
                      </div>
                      <div class="avatar-group-item">
                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Malou Silva">
                          <img src="<?= base_url() ?>public/images/users/avatar-5.jpg" alt="" class="rounded-circle avatar-xxs">
                        </a>
                      </div>
                      <div class="avatar-group-item">
                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Simon Schmidt">
                          <img src="<?= base_url() ?>public/images/users/avatar-6.jpg" alt="" class="rounded-circle avatar-xxs">
                        </a>
                      </div>
                      <div class="avatar-group-item">
                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Tosh Jessen">
                          <img src="<?= base_url() ?>public/images/users/avatar-7.jpg" alt="" class="rounded-circle avatar-xxs">
                        </a>
                      </div>
                      <div class="avatar-group-item">
                        <a href="javascript: void(0);">
                    ...
                    <div class="avatar-group">
                      <div class="avatar-group-item">
                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Nina Schmidt">
                          <img src="<?= base_url() ?>public/images/users/avatar-8.jpg" alt="" class="rounded-circle avatar-xxs">
                        </a>
                      </div>
                      <div class="avatar-group-item">
                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Stine Nielsen">
            ...
            <div class="align-items-center mt-2 row g-3 text-center text-sm-start">
              <div class="col-sm">
                <div class="text-muted">Showing<span class="fw-semibold"> 5</span> of <span class="fw-semibold">125</span> Results
                </div>
              </div>
              <div class="col-sm-auto">
          ...
          <table class="table table-nowrap table-centered align-middle">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <img src="<?= base_url() ?>public/images/users/avatar-1.jpg" class="avatar-xxs rounded-circle me-1" alt="" />
              ...
              <tr>
                ...
                <td>
                  <img src="<?= base_url() ?>public/images/users/avatar-2.jpg" class="avatar-xxs rounded-circle me-1" alt="" />
              ...
              <tr>
                ...
                <td>
                  <img src="<?= base_url() ?>public/images/users/avatar-3.jpg" class="avatar-xxs rounded-circle me-1" alt="" />
              ...
              <tr>
                ...
                <td>
                  <img src="<?= base_url() ?>public/images/users/avatar-5.jpg" class="avatar-xxs rounded-circle me-1" alt="" />
              ...
              <tr>
                ...
                <td>
                  <img src="<?= base_url() ?>public/images/users/avatar-6.jpg" class="avatar-xxs rounded-circle me-1" alt="" />
        ...
        <div class="table-responsive table-card">
          <table class="table table-borderless table-nowrap align-middle mb-0">
            ...
            <tbody>
              <tr>
                <td class="d-flex">
                  <img src="<?= base_url() ?>public/images/users/avatar-1.jpg" alt="" class="avatar-xs rounded-3 me-2" />
                  <div>
              ...
              <tr>
                <td class="d-flex">
                  <img src="<?= base_url() ?>public/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-3 me-2" />
                  <div>
              ...
              <tr>
                <td class="d-flex">
                  <img src="<?= base_url() ?>public/images/users/avatar-7.jpg" alt="" class="avatar-xs rounded-3 me-2" />
                  <div>
              ...
              <tr>
                <td class="d-flex">
                  <img src="<?= base_url() ?>public/images/users/avatar-4.jpg" alt="" class="avatar-xs rounded-3 me-2" />
                  <div>
              ...
              <tr>
                <td class="d-flex">
                  <img src="<?= base_url() ?>public/images/users/avatar-6.jpg" alt="" class="avatar-xs rounded-3 me-2" />
                  <div>
              ...
              <tr>
                <td class="d-flex">
                  <img src="<?= base_url() ?>public/images/users/avatar-5.jpg" alt="" class="avatar-xs rounded-3 me-2" />
                  <div>
              ...
              <tr>
                <td class="d-flex">
                  <img src="<?= base_url() ?>public/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-3 me-2" />
                  <div>
              ...
              <li class="chat-list left">
                <div class="conversation-list">
                  <div class="chat-avatar">
                    <img src="<?= base_url() ?>public/images/users/avatar-2.jpg" alt="" />
                  </div>
                    ...
                    <div class="ctext-wrap">
                      <div class="message-img mb-0">
                        <div class="message-img-list">
                          <div>
                            <a class="popup-img d-inline-block" href="<?= base_url() ?>public/images/small/img-1.jpg">
                              <img src="<?= base_url() ?>public/images/small/img-1.jpg" alt="" class="rounded border" />
                            </a>
                          </div>
                          <div class="message-img-link">
                            <ul class="list-inline mb-0">
                              <li class="list-inline-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                  <a class="dropdown-item" href="<?= base_url() ?>public/images/small/img-1.jpg" download=""><i class="ri-download-2-line me-2 text-muted align-bottom"></i>Download</a>
                                  <a class="dropdown-item" href="#"><i class="ri-reply-line me-2 text-muted align-bottom"></i>Reply</a>
                                  <a class="dropdown-item" href="#"><i class="ri-share-line me-2 text-muted align-bottom"></i>Forward</a>
                                  <a class="dropdown-item" href="#"><i class="ri-bookmark-line me-2 text-muted align-bottom"></i>Bookmark</a>
                                  <a class="dropdown-item delete-item" href="#"><i class="ri-delete-bin-5-line me-2 text-muted align-bottom"></i>Delete</a>
                        ...
                        <div class="message-img-list">
                          <div>
                            <a class="popup-img d-inline-block" href="<?= base_url() ?>public/images/small/img-2.jpg">
                              <img src="<?= base_url() ?>public/images/small/img-2.jpg" alt="" class="rounded border" />
                            </a>
                          </div>
                          <div class="message-img-link">
                            <ul class="list-inline mb-0">
                              <li class="list-inline-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                  <a class="dropdown-item" href="<?= base_url() ?>public/images/small/img-2.jpg" download=""><i class="ri-download-2-line me-2 text-muted align-bottom"></i>Download</a>
                                  <a class="dropdown-item" href="#"><i class="ri-reply-line me-2 text-muted align-bottom"></i>Reply</a>
                                  <a class="dropdown-item" href="#"><i class="ri-share-line me-2 text-muted align-bottom"></i>Forward</a>
                                  <a class="dropdown-item" href="#"><i class="ri-bookmark-line me-2 text-muted align-bottom"></i>Bookmark</a>
                                  <a class="dropdown-item delete-item" href="#"><i class="ri-delete-bin-5-line me-2 text-muted align-bottom"></i>Delete</a>
