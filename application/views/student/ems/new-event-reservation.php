                            ...
                            <div>
                                ...
                                <div class="row">
                                    <div class="col-lg mb-3">
                                        ...
                                        <label for="pillarsfloatingInput">Platform</label>
                                        </div>
                                    </div>
                                    <div class="col-lg mb-3">
                                        <div class="form-floating">
                                            <input type="number" class="form-control" placeholder="Participants" id="participantsfloatinginput" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="Estimated number of participants on the event" required>
                                                ...
                                                <span class="row form-check">
                                                    ...
                                                    <div class="col-lg">
                                                        <label class="form-check-label" for="formCheck1">
                                                            I assure that all information put in this form have been checked and accomplished at the best of my knowledge. In accordance with this, I agree to MyPUPQC's Event Monitoring System's <a href="<?= base_url() ?>student/evrsers/reservationpolicy/" id="reservation-policy">One Reservation Policy</a> and to PUP Quezon City's <a href="<?= base_url() ?>terms/" rel="noopener noreferrer">Terms</a> and <a href="<?= base_url() ?>privacy/" rel="noopener noreferrer">Privacy Statement.</a>
                                                        </label>
                                                    </div>
                                                </span>
                                            </div>
...
<div id="decline_create_reservation" class="row d-none px-5">
    <div class="py-5 col-12 d-flex justify-content-center align-items-center text-center flex-column gap-2">
        ...
        <a href="<?= base_url() ?>student/ems/view-event-reservation" role="button" class="btn btn-primary bg-gradient waves-effect waves-light">Go to the Reservation Page</a>
    </div>
</div>