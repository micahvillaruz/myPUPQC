                            ...
                            <div>
                                <div class="row pt-4 ">
                                    <div class="col-xxl-9">
                                        <div class="card">
                                            <div class="card-body">
                                                <h3 class="mb-3 text-primary">Student Organizations</h3>
                                                <div class="mx-3">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <div class="mb-3 d-flex justify-content-center">
                                                            <img src="<?= base_url() ?>public/images/orgs/domtcs.webp" alt="DOMTCS" class="img-thumbnail w-25">
                                                        </div>
                                                        ...
                                                        <div class="row my-5">
                                                            <div class="col">
                                                                <ul class="list-group list-group-flush">
                                                                    <h4 class="text-center">Mission</h4>
                                                                    <li class="list-group-item">Educate students as to what the Student Organization is and does. Provide extensive leadership opportunities. Facilitate discussion between all members of the campus and the community. </li>
                                                                </ul>
                                                            </div>
                                                            <div class="col">
                                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <div>
                                                        <div class="mb-3 d-flex justify-content-center">
                                                            <img src="<?= base_url() ?>public/images/orgs/fbto.webp" alt="FBTO" class="img-thumbnail w-25">
                                                        </div>
                                                    ...
                                                    <div>
                                                        <div class="mb-3 d-flex justify-content-center">
                                                            <img src="<?= base_url() ?>public/images/orgs/jms.webp" alt="JMS" class="img-thumbnail w-25">
                                                        </div>
                                                    ...
                                                    <div>
                                                        <div class="mb-3 d-flex justify-content-center">
                                                            <img src="<?= base_url() ?>public/images/orgs/yes.webp" alt="YES" class="img-thumbnail w-25">
                                                        </div>
                                                    ...
                                                    <div>
                                                        <div class="mb-3 d-flex justify-content-center">
                                                            <img src="<?= base_url() ?>public/images/orgs/irock.webp" alt="iROCK" class="img-thumbnail w-25">
                                                        </div>
                                                    ...
                                                    <div>
                                                        <div class="mb-3 d-flex justify-content-center">
                                                            <img src="<?= base_url() ?>public/images/orgs/kataga.webp" alt="KATAGA" class="img-thumbnail w-25">
                                                        </div>
                                                    ...
                                                    <div>
                                                        <div class="mb-3 d-flex justify-content-center">
                                                            <img src="<?= base_url() ?>public/images/orgs/musa.webp" alt="MUSA" class="img-thumbnail w-25">
                                                        </div>
                                                        ...
                                                        <div class="row my-5">
                                                            <div class="col">
                                                                <ul class="list-group list-group-flush">
                                                                    <h4 class="text-center">Mission</h4>
                                                                    <li class="list-group-item">a. Ipakilala at Patatagin ang Sining at Kulturang Pilipino sa mga mag-aaral ng Unibersidad.
                                                                        <br>b. Bigyan ng pagkakataon ang bawat mag-aaral ng pagkakataon na maipamalas at mapagyaman ang abilidad at kakayahang taglay.
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            <div class="col">
                                                                <ul class="list-group list-group-flush">
                                                                    <h4 class="text-center">Vision</h4>
                                                                    <li class="list-group-item">Maging sentrong organisasyon ng mga mag-aaral ng Unibersidad sa Sining at Kulturang Pilipino.</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
