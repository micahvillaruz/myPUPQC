                            ...
                            <div>
                                <div class="row pt-4 ">
                                    <div class="col-xxl-9">
                                        <div class="card">
                                            <div class="card-body">
                                                <h2 class="mb-3 text-primary text-center">Student Organizations</h2>
                                                <div class="mx-3">
                                                    <div class="border">
                                                        <div class="row my-5">
                                                            <div class="col">
                                                ...
                                                <br>
                                                    <h2 class="mb-3 text-primary text-center">Academic Organizations</h2>
                                                    <div class="border">
                                                    <div>
                                                        <div class="row my-5">
                                                            <div class="col">
                                                    ...
                                                    <div class="border">
                                                        <div class="row my-5">
                                                            <div class="col">
                                                                ...
                                                                <h3 class="text-center text-primary">Distinguished Organization of Management Technologist and Corporate Specialist (DOMTCS)</h3>
                                                            </div>
                                                            <div class="col">
                                                                <ul class="list-group list-group-flush">
                                                                    <h4 class="text-center">Mission</h4>    
                                                    ...
                                                    <br>
                                                    <h2 class="mb-3 text-primary text-center">Non-Academic Organizations</h2>
                                                    <div class="border">
                                                        <div class="mb-3 d-flex justify-content-center">
