                ...
                <div class="row pt-4 text-muted">
                  <div class="col-xxl-9">
                    <div class="card shadow-none">
                      <div class="card-body">
                        <h3 class="mb-3 text-primary">University Events and Activities</h3>
                              ...
                              <div class="text-center">
                                <ul class="list-inline categories-filter animation-nav mb-0" id="filter">
                                  <li class="list-inline-item">
                                    <a class="categories active" data-filter=".event2022">2022</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".event2021">2021</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".event2020">2020</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".event2019">2019</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".event2018">2018</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".event2017">2017</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".event2016">2016</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".event2015">2015</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".event2014">2014</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".event2013">2013</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".event2012">2012</a>
                                  </li>
                                </ul>
                              </div>
                            </div>
