      ...
      <div class="row">
        <div class="col-xl-9 col-lg-8">
          <div class="card">
            <div class="card-body">
              <div class="text-muted">
                <h2 class="text-center h3 mb-0">PUP: The National Polytechnic University</h2>
          ...
          <div class="card">
            <div class="card-body">
              <div class="text-muted">
                <h2 class="text-primary fw-medium">Mission (Misyon)</h2>
                <div class="row">
        ...
        <div class="col-xl-3 col-lg-4">
          ...
          <div class="list-group list-group-fill-success">
            ...
            <a href="#" class="list-group-item list-group-item-action">Storage folder</a>
