              ...
              <div>
                <div class="row pt-4 text-muted">
                  <div class="col-xxl-9">
                    <div class="card">
                      <div class="card-body">
                        <h3 class="mb-3 text-primary">Faculty</h3>
                        <h5 class="text-primary">Regular Faculty Members</h5>
                        <div class="m-4">
                        ...
                        <h5 class="text-primary">Part-time Faculty Members</h5>
                        <div class="m-4">
                          <div data-simplebar class="mx-n3">
                            <ul class="list list-group list-group-flush mb-0">
                              <li class="list-group-item" data-id="01">
