                ...
                <div class="row pt-4 ">
                  <div class="col-xxl-9">
                    <div class="card shadow-none">
                      <div class="card-body">
                        <h3 class="mb-3 text-primary">Executive Orders</h3>
                              ...
                              <div class="text-center">
                                <ul class="list-inline categories-filter animation-nav mb-0" id="filter">
                                  <li class="list-inline-item">
                                    <a class="categories active" data-filter=".exec2022">2022</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".exec2021">2021</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".exec2020">2020</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".exec2019">2019</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".exec2018">2018</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".exec2017">2017</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".exec2016">2016</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".exec2015">2015</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".exec2014">2014</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".exec2013">2013</a>
                                  </li>
                                  <li class="list-inline-item">
                                    <a class="categories" data-filter=".exec2012">2012</a>
                                  </li>
                                </ul>
                              </div>
                            </div>
                      ...
                      <div class="row gallery-wrapper bg-light py-3">
                        <div class="element-item col-xxl-3 col-xl-4 col-sm-6 exec2022" data-category="exec2022">
                          <div class="gallery-box card">
                            <div class="gallery-container">
                              <a class="image-popup" href="<?= base_url() ?>public/images/about/executive-orders/img-1.webp" alt="exec" title="">
                              ...
                              <div class="d-flex align-items-center mt-1">
                                <div class="flex-grow-1">
                                  <a href="" class="text-body text-truncate">
                                    ...
                                    Executive Order No. 23 Series of 2022
                                  </a>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="element-item col-xxl-3 col-xl-4 col-sm-6 exec2022" data-category="exec2022">
                          <div class="gallery-box card">
                            <div class="gallery-container">
                              <a class="image-popup" href="<?= base_url() ?>public/images/about/executive-orders/img-2.webp" alt="exec" title="">
                            ...
                            <div class="box-content">
                              <div class="d-flex align-items-center mt-1">
                                <div class="flex-grow-1">
                                  <a href="" class="text-body text-truncate">
                                    <i class="mdi mdi-bullhorn-variant text-primary align-bottom me-1"></i>
                                    Executive Order No. 22 Series of 2022</a>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="element-item col-xxl-3 col-xl-4 col-sm-6 exec2022" data-category="exec2022">
                          <div class="gallery-box card">
                            <div class="gallery-container">
                              <a class="image-popup" href="<?= base_url() ?>public/images/about/executive-orders/img-3.webp" alt="exec" title="">
                            ...
                            <div class="box-content">
                              <div class="d-flex align-items-center mt-1">
                                <div class="flex-grow-1">
                                  <a href="" class="text-body text-truncate">
                                    <i class="mdi mdi-bullhorn-variant text-primary align-bottom me-1"></i>
                                    Executive Order No. 21 Series of 2022</a>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="element-item col-xxl-3 col-xl-4 col-sm-6 exec2022" data-category="exec2022">
                          <div class="gallery-box card">
                            <div class="gallery-container">
                              <a class="image-popup" href="<?= base_url() ?>public/images/about/executive-orders/img-4.webp" alt="exec" title="">
                            ...
                            <div class="box-content">
                              <div class="d-flex align-items-center mt-1">
                                <div class="flex-grow-1">
                                  <a href="" class="text-body text-truncate">
                                    <i class="mdi mdi-bullhorn-variant text-primary align-bottom me-1"></i>
                                    Executive Order No. 20 Series of 2022</a>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="element-item col-xxl-3 col-xl-4 col-sm-6 exec2022" data-category="exec2022">
                          <div class="gallery-box card">
                            <div class="gallery-container">
                              <a class="image-popup" href="<?= base_url() ?>public/images/about/executive-orders/img-5.webp" alt="exec" title="">
                            ...
                            <div class="box-content">
                              <div class="d-flex align-items-center mt-1">
                                <div class="flex-grow-1">
                                  <a href="" class="text-body text-truncate">
                                    <i class="mdi mdi-bullhorn-variant text-primary align-bottom me-1"></i>
                                    Executive Order No. 19 Series of 2022</a>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="element-item col-xxl-3 col-xl-4 col-sm-6 exec2022" data-category="exec2022">
                          <div class="gallery-box card">
                            <div class="gallery-container">
                              <a class="image-popup" href="<?= base_url() ?>public/images/about/executive-orders/img-6.webp" alt="exec" title="">
                            ...
                            <div class="box-content">
                              <div class="d-flex align-items-center mt-1">
                                <div class="flex-grow-1">
                                  <a href="" class="text-body text-truncate">
                                    <i class="mdi mdi-bullhorn-variant text-primary align-bottom me-1"></i>
                                    Executive Order No. 18 Series of 2022</a>
                                </div>
                              </div>
                            </div>
                          </div>
