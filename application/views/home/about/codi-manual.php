              ...
              <div>
                <div class="row pt-4 text-muted">
                  <div class="col-xxl-9">
                    <div class="card">
                      <div class="card-body">
                        <h3 class="mb-3 text-primary">CODI Manual</h3>
                        <div class="mx-3 mb-5">
                          <iframe src="https://drive.google.com/file/d/1Bji_1d87hsv9ic07RH64cxHZQt-3RG4B/preview" width="100%" height="1000px" allow="autoplay"></iframe>
                        </div>
                      </div>
                      <!--end card-body-->
                    </div>
