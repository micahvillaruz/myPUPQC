              ...
              <div>
                <div class="row pt-4 text-muted">
                  <div class="col-xxl-9">
                    <div class="card">
                      <div class="card-body">
                        <h3 class="mb-4 text-primary">Logo and Symbols</h3>
                        <div class="mb-4">
                          ...
                          <div class="d-flex justify-content-center">
                            <img src="<?= base_url() ?>public\images\pastlogos.gif" alt="" height="150" class="mb-4" />
                          </div>
                        ...
                        <div class="mb-4">
                          ...
                          <div class="text-center">
                            <img src="<?= base_url() ?>public\images\pupmural.jpg" alt="" height="200" class="mb-4" />
                          </div>
                        ...
                        <div class="mb-4">
                          ...
                          <div class="text-center">
                            <img src="<?= base_url() ?>public\images\centenniallogo.gif" alt="" height="200" class="mb-4" />
                          </div>
                          <p>
                          ...
                          <p>
                            Ten small arrows spring from the circle to herald the University's concern for people from all walks of life, through the service and commitment in seven branches and three campuses throughout the nation.</p>
                        </div>
                      </div>
                      <!--end card-body-->
                    </div>
