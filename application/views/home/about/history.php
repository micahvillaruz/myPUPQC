        ...
        <div class="container-boxed">
          ...
          <div class="pt-4 mb-4 mb-lg-3 pb-lg-4">
            <div class="row g-4">
              <div class="col-auto">
                <div class="avatar-lg">
                  <img src="<?= base_url() ?>public/images/pupqc-logo.webp" allt="PUP Logo" class="img-thumbnail rounded-circle" />
                </div>
              </div>
              <!--end col-->
              <div class="col">
              ...
              <div>
                <div class="row pt-4 ">
                  <div class="col-xxl-9">
                    <div class="card">
                      <div class="card-body">
                        <h3 class="mb-3 text-primary">History</h3>
                        <div class="m-3">
                          <div class="row">
                            <p>
                            ...
                            <p>
                              Later on, the 1.9 hectares of land was also donated to PUP by the SIKHAY â€“ an association duly registered with the Securities and Exchange Commission (SEC) represented by its President, Rev. Fr. Joel E. Tabora, S.J.
                            </p>
                            <p>
                            ...
                            <p>Today, it offered the following programs:</p>
                            <h5 class="text-primary mt-1">Undergraduate Programs:</h5>
                            <ul class="mx-4">
                              <li> Bachelor of Science in Information Technology</li>
                              <li> Bachelor in Business Teacher and Livelihood Education major in Home Economics</li>
                              <li> Bachelor in Business Teacher and Livelihood Education major in Information Communication Technology</li>
                              ...
                              <li> Diploma in Office Management Technology with specialization in Medical Office Management</li>
                            </ul>
                            <h5 class="text-primary mt-1">Graduate Studies Programs under the PUP Open University System</h5>
                            <ul class="mx-4">
