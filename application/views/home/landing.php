		...
		<nav class="navbar navbar-expand-lg navbar-landing fixed-top" id="navbar">
			<div class="container">
				<a class="navbar-brand" href="index.html">
					<img src="<?= base_url() ?>public/images/logo-dark.png" class="card-logo card-logo-dark" alt="logo dark" height="17" />
					<img src="<?= base_url() ?>public/images/logo-light.png" class="card-logo card-logo-light" alt="logo light" height="17" />
				</a>
					...
					<div class="col-lg-8 col-sm-10">
						<div class="text-center mt-lg-5 pt-5">
							<h1 class="display-6 fw-semibold mb-3 lh-base">
								...
								<span class="text-success">myPUPQC </span>
							</h1>
							<p class="lead text-muted lh-base">
								Velzon is a fully responsive, multipurpose and premium Bootstrap 5 Admin &
								Dashboard Template built in multiple frameworks.
							</p>
						...
						<div class="mt-4 mt-sm-5 pt-sm-5 mb-sm-n5 demo-carousel">
							<div class="demo-img-patten-top d-none d-sm-block">
								<img src="<?= base_url() ?>public/images/landing/img-pattern.png" class="d-block img-fluid" alt="..." />
							</div>
							...
							<div class="carousel slide carousel-fade" data-bs-ride="carousel">
								<div class="carousel-inner shadow-lg p-2 bg-white rounded">
									<div class="carousel-item active" data-bs-interval="2000">
										<img src="<?= base_url() ?>public/images/demos/default.png" class="d-block w-100" alt="..." />
									</div>
									<div class="carousel-item" data-bs-interval="2000">
										<img src="<?= base_url() ?>public/images/demos/saas.png" class="d-block w-100" alt="..." />
									</div>
									<div class="carousel-item" data-bs-interval="2000">
										<img src="<?= base_url() ?>public/images/demos/material.png" class="d-block w-100" alt="..." />
									</div>
									<div class="carousel-item" data-bs-interval="2000">
										<img src="<?= base_url() ?>public/images/demos/minimal.png" class="d-block w-100" alt="..." />
									</div>
									<div class="carousel-item" data-bs-interval="2000">
										<img src="<?= base_url() ?>public/images/demos/creative.png" class="d-block w-100" alt="..." />
									</div>
									<div class="carousel-item" data-bs-interval="2000">
										<img src="<?= base_url() ?>public/images/demos/modern.png" class="d-block w-100" alt="..." />
									</div>
									<div class="carousel-item" data-bs-interval="2000">
										<img src="<?= base_url() ?>public/images/demos/interactive.png" class="d-block w-100" alt="..." />
									</div>
								</div>
							</div>
						</div>
								...
								<div class="swiper-wrapper">
									<div class="swiper-slide">
										<div class="client-images">
											<img src="<?= base_url() ?>public/images/clients/amazon.svg" alt="client-img" class="mx-auto img-fluid d-block" />
										</div>
									</div>
									<div class="swiper-slide">
										<div class="client-images">
											<img src="<?= base_url() ?>public/images/clients/walmart.svg" alt="client-img" class="mx-auto img-fluid d-block" />
										</div>
									</div>
									<div class="swiper-slide">
										<div class="client-images">
											<img src="<?= base_url() ?>public/images/clients/lenovo.svg" alt="client-img" class="mx-auto img-fluid d-block" />
										</div>
									</div>
									<div class="swiper-slide">
										<div class="client-images">
											<img src="<?= base_url() ?>public/images/clients/paypal.svg" alt="client-img" class="mx-auto img-fluid d-block" />
										</div>
									</div>
									<div class="swiper-slide">
										<div class="client-images">
											<img src="<?= base_url() ?>public/images/clients/shopify.svg" alt="client-img" class="mx-auto img-fluid d-block" />
										</div>
									</div>
									<div class="swiper-slide">
										<div class="client-images">
											<img src="<?= base_url() ?>public/images/clients/verizon.svg" alt="client-img" class="mx-auto img-fluid d-block" />
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-8">
						<div class="text-center mb-5">
							...
							<p class="text-muted">
								...
								more common words. If several languages coalesce the grammar
							</p>
						</div>
					</div>
					<!-- end col -->
					...
					<div class="col-lg-4">
						<div class="d-flex p-3">
							...
							<div class="flex-grow-1">
								...
								<p class="text-muted my-3 ff-secondary">
									The collection of rules and guidelines which designers use to communicate with
					...
					<div class="col-lg-4">
						<div class="d-flex p-3">
							...
							<div class="flex-grow-1">
								...
								<p class="text-muted my-3 ff-secondary">
									Business development firm that provides strategic planning, market research
					...
					<div class="col-lg-4">
						<div class="d-flex p-3">
							...
							<div class="flex-grow-1">
								...
								<p class="text-muted my-3 ff-secondary">
									Awesome Support is the most versatile and feature-rich support plugin for all
									version.
								</p>
								<div>
									<a href="#" class="fs-13 fw-medium">Learn More <i class="ri-arrow-right-s-line align-bottom"></i></a>
					...
					<div class="col-lg-4">
						<div class="d-flex p-3">
							...
							<div class="flex-grow-1">
								...
								<p class="text-muted my-3 ff-secondary">
									Personalise your own website, no matter what theme and what customization
									options.
								</p>
								<div>
									<a href="#" class="fs-13 fw-medium">Learn More <i class="ri-arrow-right-s-line align-bottom"></i></a>
					...
					<div class="col-lg-4">
						<div class="d-flex p-3">
							...
							<div class="flex-grow-1">
								...
								<p class="text-muted my-3 ff-secondary">
									Responsive design is a graphic user interface (GUI) design approach used to
									create content.
								</p>
								<div>
									<a href="#" class="fs-13 fw-medium">Learn More <i class="ri-arrow-right-s-line align-bottom"></i></a>
					...
					<div class="col-lg-4">
						<div class="d-flex p-3">
							...
							<div class="flex-grow-1">
								...
								<p class="text-muted my-3 ff-secondary">
									An industrial specialist works with industrial operations to ensure that
			...
			<div class="container">
				<div class="row align-items-center gy-4">
					<div class="col-lg-6 col-sm-7 mx-auto">
						<div>
							<img src="<?= base_url() ?>public/images/landing/features/img-1.png" alt="" class="img-fluid mx-auto" />
						</div>
					</div>
					<div class="col-lg-6">
						<div class="text-muted">
							...
							<p class="mb-4 ff-secondary fs-16">
								...
								as a collection of pictures from a collection of articles from a news app or a
								collection of messages from a communication app.
							</p>
			...
			<div class="container">
				<div class="row align-items-center gy-4">
					<div class="col-lg-6 order-2 order-lg-1">
						<div class="text-muted">
							...
							<p class="mb-4 ff-secondary">
								Quality Dashboards (QD) is a condition-specific, actionable web-based application
								for quality reporting and population management that is integrated into the
					...
					<div class="col-lg-6 col-sm-7 col-10 ms-auto order-1 order-lg-2">
						<div>
							<img src="<?= base_url() ?>public/images/landing/features/img-2.png" alt="" class="img-fluid" />
						</div>
					</div>
				</div>
				<!-- end row -->
				...
				<div class="row align-items-center mt-5 pt-lg-5 gy-4">
					<div class="col-lg-6 col-sm-7 col-10 mx-auto">
						<div>
							<img src="<?= base_url() ?>public/images/landing/features/img-3.png" alt="" class="img-fluid" />
						</div>
					</div>
					<div class="col-lg-6">
						<div class="text-muted ps-lg-5">
							...
							<p class="mb-4">
								used to describe something that is known about or known to be true because there
								are many documents that describe it, prove it, etc.
							</p>
					...
					<div class="col-lg-8">
						<div class="text-center mb-5">
							...
							<p class="text-muted mb-4 ff-secondary">
								If you can not find answer to your question in our FAQ, you can always contact us
								or email us. We will answer you shortly!
							</p>
							...
							<div class="accordion-item">
								...
								<div id="genques-collapseOne" class="accordion-collapse collapse show" aria-labelledby="genques-headingOne" data-bs-parent="#genques-accordion">
									<div class="accordion-body ff-secondary">
										...
										your entire presentation to give it a consistent, professional look. You've
										already been using a theme, even if you didn't know it: the default Office
							...
							<div class="accordion-item">
								...
								<div id="genques-collapseTwo" class="accordion-collapse collapse" aria-labelledby="genques-headingTwo" data-bs-parent="#genques-accordion">
									<div class="accordion-body ff-secondary">
										...
										patterns and parallels within the story itself. In looking at ways to separate
										themes into a hierarchy, we might find it useful to follow the example of a
										single book.
									</div>
								</div>
							</div>
							<div class="accordion-item">
								...
								<div id="genques-collapseThree" class="accordion-collapse collapse" aria-labelledby="genques-headingThree" data-bs-parent="#genques-accordion">
									<div class="accordion-body ff-secondary">
										...
										authors. Themes must register each individual Theme Feature that the author
										wishes to support. Theme support functions should be called in the theme's
										functions.
									</div>
								</div>
							</div>
							<div class="accordion-item">
								...
								<div id="genques-collapseFour" class="accordion-collapse collapse" aria-labelledby="genques-headingFour" data-bs-parent="#genques-accordion">
									<div class="accordion-body ff-secondary">
										...
										for: simplicity. Immediately upgrade the quality of your WordPress site with
										the simple theme To use the built-in Chrome theme editor.
									</div>
								</div>
							</div>
						</div>
							...
							<div class="accordion-item">
								...
								<div id="privacy-collapseOne" class="accordion-collapse collapse" aria-labelledby="privacy-headingOne" data-bs-parent="#privacy-accordion">
									<div class="accordion-body ff-secondary">
										...
										help reduce eye strain in low light settings. You can choose to make the
										document white or black using the Switch Modes button in the ribbon's View
										tab.
									</div>
								</div>
							</div>
							<div class="accordion-item">
								...
								<div id="privacy-collapseTwo" class="accordion-collapse collapse show" aria-labelledby="privacy-headingTwo" data-bs-parent="#privacy-accordion">
									<div class="accordion-body ff-secondary">
										...
										during that period theme is an idea that a writer repeats.
									</div>
								</div>
							</div>
							<div class="accordion-item">
								...
								<div id="privacy-collapseThree" class="accordion-collapse collapse" aria-labelledby="privacy-headingThree" data-bs-parent="#privacy-accordion">
									<div class="accordion-body ff-secondary">
										...
										that narrative involves mystery, terror, romance, comedy, or all of the above.
										These works of fiction may also contain memorable characters, vivid
											...
											<div class="col-10">
												<div class="text-white-50">
													<p class="fs-20 ff-secondary mb-4">
														" I am givng 5 stars. Theme is great and everyone one stuff everything
														in theme. Future request should not affect current state of theme. "
													</p>
									...
									<div class="swiper-slide">
										<div class="row justify-content-center">
											<div class="col-10">
												<div class="text-white-50">
													<p class="fs-20 ff-secondary mb-4">
														" Awesome support. Had few issues while setting up because of my
														device, the support team helped me fix them up in a day. Everything
														looks clean and good. Highly recommended! "
													</p>
									...
									<div class="swiper-slide">
										<div class="row justify-content-center">
											<div class="col-10">
												<div class="text-white-50">
													<p class="fs-20 ff-secondary mb-4">
														" Amazing template, Redux store and components is nicely designed.
														It's a great start point for an admin based project. Clean Code and
														good documentation. Template is completely in React and absolutely no
														usage of jQuery "
													</p>
					...
					<div class="col-lg-8">
						<div class="text-center mb-5">
							...
							<p class="text-muted mb-4 ff-secondary">
								...
								importance of having web copy before the Proin vitae ipsum vel ex finibus semper
								design starts.
							</p>
						</div>
					</div>
					...
					<div class="col-lg-4">
						<div class="process-card mt-4">
							<div class="process-arrow-img d-none d-lg-block">
								<img src="<?= base_url() ?>public/images/landing/process-arrow-img.png" alt="" class="img-fluid" />
							</div>
				...
				<div class="row">
						...
						<div class="card">
							<div class="card-body text-center p-4">
								<div class="avatar-xl mx-auto mb-4 position-relative">
									<img src="<?= base_url() ?>public/images/users/avatar-2.jpg" alt="" class="img-fluid rounded-circle" />
								...
								<!-- end card body -->
								<h5 class="mb-1">
									<a href="pages-profile.html" class="text-body">Nancy Martino</a>
								</h5>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="card">
							<div class="card-body text-center p-4">
								<div class="avatar-xl mx-auto mb-4 position-relative">
									<img src="<?= base_url() ?>public/images/users/avatar-10.jpg" alt="" class="img-fluid rounded-circle" />
									<a href="apps-mailbox.html" class="btn btn-success btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
										<div class="avatar-title bg-transparent">
											<i class="ri-mail-fill align-bottom"></i>
										</div>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="card">
							<div class="card-body text-center p-4">
								<div class="avatar-xl mx-auto mb-4 position-relative">
									<img src="<?= base_url() ?>public/images/users/avatar-3.jpg" alt="" class="img-fluid rounded-circle" />
									<a href="apps-mailbox.html" class="btn btn-success btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
										<div class="avatar-title bg-transparent">
											<i class="ri-mail-fill align-bottom"></i>
										</div>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="card">
							<div class="card-body text-center p-4">
								<div class="avatar-xl mx-auto mb-4 position-relative">
									<img src="<?= base_url() ?>public/images/users/avatar-8.jpg" alt="" class="img-fluid rounded-circle" />
									<a href="apps-mailbox.html" class="btn btn-success btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
										<div class="avatar-title bg-transparent">
											<i class="ri-mail-fill align-bottom"></i>
										</div>
								...
								<!-- end card body -->
								<h5 class="mb-1">
									<a href="pages-profile.html" class="text-body">Donald Palmer</a>
								</h5>
				...
				<div class="row">
					<div class="col-lg-3 col-sm-6">
						<div class="card">
							<div class="card-body text-center p-4">
								<div class="avatar-xl mx-auto mb-4 position-relative">
									<img src="<?= base_url() ?>public/images/users/avatar-5.jpg" alt="" class="img-fluid rounded-circle" />
									<a href="apps-mailbox.html" class="btn btn-success btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
										<div class="avatar-title bg-transparent">
											<i class="ri-mail-fill align-bottom"></i>
										</div>
								...
								<!-- end card body -->
								<h5 class="mb-1">
									<a href="pages-profile.html" class="text-body">Erica Kernan</a>
								</h5>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="card">
							<div class="card-body text-center p-4">
								<div class="avatar-xl mx-auto mb-4 position-relative">
									<img src="<?= base_url() ?>public/images/users/avatar-4.jpg" alt="" class="img-fluid rounded-circle" />
									<a href="apps-mailbox.html" class="btn btn-success btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
										<div class="avatar-title bg-transparent">
											<i class="ri-mail-fill align-bottom"></i>
										</div>
								...
								<!-- end card body -->
								<h5 class="mb-1">
									<a href="pages-profile.html" class="text-body">Alexis Clarke</a>
								</h5>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="card">
							<div class="card-body text-center p-4">
								<div class="avatar-xl mx-auto mb-4 position-relative">
									<img src="<?= base_url() ?>public/images/users/avatar-6.jpg" alt="" class="img-fluid rounded-circle" />
									<a href="apps-mailbox.html" class="btn btn-success btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
										<div class="avatar-title bg-transparent">
											<i class="ri-mail-fill align-bottom"></i>
										</div>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="card">
							<div class="card-body text-center p-4">
								<div class="avatar-xl mx-auto mb-4 position-relative">
									<img src="<?= base_url() ?>public/images/users/avatar-7.jpg" alt="" class="img-fluid rounded-circle" />
									<a href="apps-mailbox.html" class="btn btn-success btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
										<div class="avatar-title bg-transparent">
											<i class="ri-mail-fill align-bottom"></i>
										</div>
					...
					<div class="col-lg-8">
						<div class="text-center mb-5">
							...
							<p class="text-muted mb-4 ff-secondary">
								...
								concept should be supported with faucibus sapien odio measurable results.
							</p>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-4 mt-4">
						<div>
							<div>
								<img src="<?= base_url() ?>public/images/logo-light.png" alt="logo light" height="17" />
							</div>
							<div class="mt-4 fs-13">
								<p>Premium Multipurpose Admin & Dashboard Template</p>
								<p class="ff-secondary">
									You can build any type of web application like eCommerce, CRM, CMS, Project
