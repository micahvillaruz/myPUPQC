              ...
              <div>
                <div class="row pt-4 text-muted">
                  <div class="col-xxl-9">
                    <div class="card">
                      <div class="card-body">
                        <h3 class="mb-3 text-primary">Privacy Statement</h3>
                        <p class="fst-italic">Last updated: June 11, 2018</p>
                        <div class="m-3">
                          <div class="row">
                            <p>
                            ...
                            <ul class="mx-4">
                              ...
                              <li> Partners with which we offer co-branded services or engage in joint research activities, and</li>
                            ...
                            <ul class="mx-4">
                              ...
                              <li><span class="fw-medium"> Device, connectivity and configuration data. </span> We collect data about your device and the network you use to connect to the Services. This include data about the operating systems and other software used in accessing the Services, such as browsers. It also includes IP address, device identifiers, regional and language settings.</li>
                              <li><span class="fw-medium"> Error reports and performance data. </span> We collect data about the performance of the Services and any problems you experience with it. This data helps us to diagnose problems in the Services you use, and to improve our Services and provide solutions. Depending on your product and settings, error reports can include data such as the type or severity of the problem, details of the Service related to an error, contents of the Service you were using when an error occurred, and data about other software on your device.</li>
                            ...
                            <ul class="mx-4">
                              ...
                              <li><span class="fw-medium"> Technical support. </span> We use data to diagnose problems in the Services, repair the problem, and provide other customer care and support services.</li>
                              <li><span class="fw-medium"> User account activation/deactivation. </span> We use data, including subscription and status identifiers, to user accounts that requires activation/deactivation.</li>
                              <li><span class="fw-medium"> Security and Safety. </span> We use data to protect the security and safety of our Services, to detect and prevent fraud, to confirm the validity of user accounts, to resolve disputes and enforce our policies. Our Services has the capability to identify abusive actions and may block the user and/or remove content if it violates our Terms.</li>
                            ...
                            <ul class="mx-4">
                              ...
                              <li> Google Analytics, Google Play, Google+:<a class="" href="https://policies.google.com/privacy">https://policies.google.com/privacy</a></li>
                              <li> Instagram: <a class="" href="https://privacycenter.instagram.com/policy/?entry_point=ig_help_center_data_policy_redirect">https://help.instagram.com/519522125107875</a></li>
                              <li> Office 365 and Outlook.com: <a class="" href="https://www.microsoft.com/en/trust-center/privacy">https://products.office.com/en/business/office-365-trust-center-privacy</a></li>
                              <li> OneDrive: <a class="" href="https://privacy.microsoft.com/en-US/">https://privacy.microsoft.com/</a></li>
                              <li> Twitter: <a class="" href="https://twitter.com/en/privacy">https://twitter.com/en/privacy</a></li>
                              <li> UserReport.com: <a class="" href="https://privacy.userreport.com/en-GB">https://privacy.userreport.com/</a></li>
                              <li> YouTube: <a class="" href="https://www.youtube.com/howyoutubeworks/policies/community-guidelines/">https://www.youtube.com/yt/about/policies/</a></li>
                            </ul>
                            ...
                            <ul class="mx-4">
                              <li><span class="fw-medium"> Office 365 </span> You can see and control activity data across Office 365 services at <a class="" href="https://portal.office.com/account/">portal.office.com/account.</a> From here, you can access or edit your profile and payment information (if applicable), view and clear browsing, search, and location data associated with your Office 365 account.</li>
                            </ul>
                            <span class="fw-medium">Browser-Based Controls </span>
                            <ul class="mx-4">
                              <li><span class="fw-medium"> Cookie Controls. </span> Relevant browser-based cookie controls are described in the Cookies section of this privacy statement.</li>
                            ...
                            <ul class="mx-4">
                              <li><span class="fw-medium"> Sign-in and Authentication. </span> When you sign into the Services or third-party providers using your PUP account, we store a unique ID number, and the time you signed in, in an encrypted cookie on your device. This cookie allows you to move from page to page within the Services without having to sign in again on each page.</li>
                              <li><span class="fw-medium"> Remembering your Preferences and Settings. </span> Settings that enable our Services to operate properly or that maintain your preferences over time may be stored on your device. For example, if you signed in the Services, we may store encrypted session data in a cookie so that you will see the relevant information or services. These preferences and settings are placed in a cookie on your device until you clear browsing data using your Web browser.</li>
                              <li><span class="fw-medium"> Interest-Based Advertising. </span> Third-party providers use cookies to collect data about your online activity and identify your interests so that the provided ads are most relevant to you. You can opt out of receiving interest-based advertising from third-party providers as described in their privacy statement.</li>
                            ...
                            <ul class="mx-4">
                              ...
                              <li><span class="fw-medium"> Do users provide, create, or maintain the data with the expectation we will retain it until they affirmatively remove it?</span> Examples include a document you store in OneDrive, or an email message you keep in your Office 365 Outlook inbox, or attachments made during online registration or reporting. In such cases, PUP and/or the third-party provider maintains the data until you actively delete it, such as by moving an email from your Office 365 Outlook inbox to the Deleted Items folder, and then emptying that folder (when your Deleted Items folder is emptied, those emptied items remain in their system for up to 30 days before final deletion).</li>
                              <li><span class="fw-medium"> Is PUP subject to a legal, contractual, or similar obligation to retain the data?</span> Examples can include mandatory data retention laws in the Philippines (or applicable jurisdiction for third-party providers), Government orders to preserve data relevant to an investigation, or data that must be retained for the purposes of due process.</li>
                            </ul>
                        ...
                        <div>
                          <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                              <a class="text-muted" href="<?= base_url() ?>privacy">Privacy Statement</a>
                            </li>
                            <li class="list-group-item text-muted">
                              <a class="text-muted" href="<?= base_url() ?>terms">Terms of Use</a>
                            </li>
                          </ul>
                        </div>
                      </div>
