...
<div id="viewRequestDetails" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h2 class="text-center"><span id="control_no" class="badge badge-outline-primary text-center fw-bold">20220340-0012</span></h2>
        <div class="row mt-4">
          <div class="col-md">
              ...
              <div class="col-md-auto">
                <div class="avatar-md">
                  <div class="avatar-title bg-white rounded-circle">
                    <img src="<?= base_url() ?>public/images/profile/flat-faces-icons-circle-man-5.png" alt="" class="avatar-md" />
                  </div>
                </div>
              </div>
              <div class="col-md">
                <div>
                  <h5>Ruivivar, Rein Joseph Balana</h5>
                  <h6>2019-00050-CM-0</h6>
                  <div class="hstack gap-3 flex-wrap">
                    ...
                    <div>
                      Email Address :
                      <span class="fw-medium">reinsaitama@gmail.com</span>
                    </div>
                    <div class="vr"></div>
                    <div>
                      Mobile Number:
                      <span class="fw-medium">09182910291</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <table class="mt-5 table table-bordered nowrap align-middle" style="width: 100%">
          ...
          <tbody>
            <tr>
              <td>Certificate of Transfer Credential (Honorable Dismissal)</td>
              <td class="text-center">1</td>
              <td class="text-center"><span class="badge bg-success">Paid</span></td>
              <td><span class="ms-2">05 Aug, 2022<small class="text-muted ms-1">11:00 AM</small></span></td>
            </tr>
            <tr>
              ...
              <div class="accordion-item border-0">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1 ms-3">
                        <h6 class="fs-15 mb-0 fw-semibold">
                          ...
                          <span class="fw-normal">Sat, 30 Jul 2022</span>
                        </h6>
                      </div>
                    </div>
                  </a>
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                  <div class="accordion-body ms-2 ps-5 pt-0">
                    ...
                    <p class="text-muted mb-0">Sat, 30 Jul 2022 - 09:11AM</p>
                  </div>
                </div>
              </div>
              <div class="accordion-item border-0">
                  ...
                  <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1 ms-3">
                        <h6 class="fs-15 mb-0 fw-semibold">
                          For Clearance -
                          <span class="fw-normal">Sun, 31 Jul 2022</span>
                        </h6>
                      </div>
                    </div>
                  </a>
              ...
              <div class="accordion-item border-0">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1 ms-3">
                        <h6 class="fs-15 mb-1 fw-semibold">
                          ...
                          <span class="fw-normal">Mon, 01 Aug 2022</span>
                        </h6>
                      </div>
                    </div>
                  </a>
                ...
                <div id="collapseThree" class="accordion-collapse collapse show" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                  <div class="accordion-body ms-2 ps-5 pt-0">
                    ...
                    <p class="text-muted mb-0">Mon, 01 Aug 2022 - 11:57PM</p>
                  </div>
                </div>
              </div>
              <div class="accordion-item border-0">
                  ...
                  <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1 ms-3">
                        <h6 class="fs-15 mb-1 fw-semibold">
                          Ready for Pickup -
                          <span class="fw-normal">Wed, 03 Aug 2022</span>
                        </h6>
                      </div>
                    </div>
                  </a>
                ...
                <div id="collapseFour" class="accordion-collapse collapse show" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                  <div class="accordion-body ms-2 ps-5 pt-0">
                    <div class="hstack gap-3 flex-wrap align-items-center">
                      ...
                      <div class="d-flex">
                        <i class="bx bxs-calendar-minus text-success me-2"></i>
                        <h6 class="fs-14">August 05, 2022</h6>
                      </div>
                      <h6 class="vr"></h6>
                      <div class="d-flex">
                        <i class="bx bxs-time-five text-warning me-2"></i>
                        <h6 class="fs-14">9:00 AM - 2:00 PM</h6>
                      </div>
                    </div>
                    ...
                    <p class="text-muted mb-0">Wed, 03 Aug 2022 - 07:20AM</p>
                  </div>
                </div>
              </div>
              <div class="accordion-item border-0">
                  ...
                  <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1 ms-3">
                        <h6 class="fs-15 mb-1 fw-semibold">
                          Released -
                          <span class="fw-normal">Fri, 05 Aug 2022</span>
                        </h6>
                      </div>
                    </div>
                  </a>
                </div>
                <div id="collapseFive" class="accordion-collapse collapse show" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                  <div class="accordion-body ms-2 ps-5 pt-0">
                    <h6 class="mb-1">The requested documents has been successfully claimed by the student.</h6>
                    <p class="text-muted mb-0">Fri, 05 Aug 2022 - 11:00AM</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="mt-4">
          ...
          <div class="list-group">
            <a href="javascript:void(0);" class="list-group-item list-group-item-action">
              ...
              <p>The Document Request is now approved. You must download the Request form and bring it together with the requirements as listed below. Your schedule for processing of requirements at PUP QC is <b>August 01, 2022</b> from <b>1:00 PM to 4:00 PM</b>.</p>
              <p>Please bring the following requirements:</p>
              <ol class="list-group list-group-numbered">
                <li class="list-group-item">Curriculum sheet</li>
                <li class="list-group-item">Course/Subject Description</li>
                <li class="list-group-item">Certification of good moral character</li>
                <li class="list-group-item">two (2) pcs. 2x2 picture with name tag</li>
              </ol>
            </a>
            <a href="javascript:void(0);" class="list-group-item list-group-item-action">
              <div class="d-flex mb-2 align-items-center">
              ...
              <p>Good Day! Please be informed that your requested credential/s is/are scheduled for pick-up on <b>August 05, 2022</b>. Please claim the credential/s at the releasing section on your scheduled date only, from <b>9:00 AM to 2:00 PM</b>. If you are unable to come on your scheduled date, you will be re-scheduled at a later date. Thank you.</p>
            </a>
          </div>
        </div>
