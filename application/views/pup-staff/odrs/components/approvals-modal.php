        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="ms-3">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-4">
                                            <p class="card-text fw-medium">(2) - Informative Copy of Grades</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <h6 class="mt-2 mb-4 text-dark">Users in this approval workflow</h6>
                    <div class="profile-timeline">
                        <div class="accordion accordion-flush" id="todayExample">
                            ...
                            <div class="accordion-item border-0">
                                <div class="accordion-header" id="headingOne">
                                    <a class="accordion-button ps-3 pt-4 shadow-none" data-bs-toggle="collapse" href="#collapseOne" aria-expanded="true">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
