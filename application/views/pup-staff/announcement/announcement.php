                ...
                <div class="card-body">
                    <form id="NewAnnouncement" class="row g-3 needs-validation" novalidate>
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="announcement_title" name="announcement_title" placeholder="Enter the title of the announcement">
                        </div>
                        <div class="col-md-12">
                            <label for="announcement_description" class="form-label">Description <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="announcement_description" name="announcement_description" placeholder="Enter the short description/headline for this announcement">
                        </div>
                        <div class="col-md-12">
