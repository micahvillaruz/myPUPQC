            ...
            <div class="card-body" style="z-index: 1;">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <p class="text-uppercase fw-medium text-muted mb-3">Registered Organization</p>
        ...
        <div class="card card-height-100 card-animate overflow-hidden">
            ...
            <div class="card-body" style="z-index: 1;">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <p class="text-uppercase fw-medium text-muted mb-3">Approved Organization</p>
