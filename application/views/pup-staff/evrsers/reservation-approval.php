...
<div id="has_no_signatory_requests" class="row my-5 py-5">
    <div class="py-5 col-12 d-flex justify-content-center align-items-center text-center flex-column gap-2">
        ...
        <p class="fs-15">You currently have no reservations to sign. <br> Please contact EVRSERS support if you think this is a mistake or click <span class="fw-medium">"View Reservations"</span> button below.</p>
