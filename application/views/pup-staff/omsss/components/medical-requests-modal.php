                ...
                <div class="mt-4">
                    ...
                    <form id="approveAppointmentForm" class="needs-validation" novalidate>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea class="form-control mt-2" id="approve_remarks" autocomplete="off" oninput="setupInputRestriction(this)" name="approve_remarks" rows="5" placeholder="As the Staff, be specific and concise with the remarks you'll provide to the student in preparation of the appointment." required></textarea>
            ...
            <div class="modal-body text-center px-4">
                ...
                <div class="mt-4">
                    ...
                    <form id="cancelAppointmentForm" class="needs-validation" novalidate>
                        ...
                        <div class="mt-4">
                            <label for="remarks" class="h5 form-label">Remarks <span class="text-danger">*</span></label>
                            <textarea class="form-control mt-2" id="cancel_remarks" autocomplete="off" oninput="setupInputRestriction(this)" name="cancel_remarks" rows="5" placeholder="Enter the reason why you are cancelling the appointment and the instructions, if any, that the student must comply before appointing for a consultation again." required></textarea>
                            <div class="invalid-feedback">
