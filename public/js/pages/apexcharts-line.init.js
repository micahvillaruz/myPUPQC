...
linechartBasicColors &&
	((options = {
		series: [{ name: 'Events', data: [2, 4, 1, 0, 3, 3, 6, 1, 6] }],
		chart: { height: 350, type: 'line', zoom: { enabled: !1 }, toolbar: { show: !1 } },
		markers: { size: 4 },
		dataLabels: { enabled: !1 },
		stroke: { curve: 'straight' },
		colors: linechartBasicColors,
		title: { text: 'Organization Events by Month', align: 'left', style: { fontWeight: 500 } },
...
linechartDatalabelColors &&
	((options = {
		...
		responsive: [
			{ breakpoint: 600, options: { chart: { toolbar: { show: !1 } }, legend: { show: !1 } } },
		],
	}),
...
lineChartGradientColors &&
	((options = {
		series: [
			{ name: 'Likes', data: [4, 3, 10, 9, 29, 19, 22, 9, 12, 7, 19, 5, 13, 9, 17, 2, 7, 5] },
		],
...
var optionsLine2,
	chartLine2,
	chartSyncingLine2 = getChartColorsArray('chart-syncing-line2')
chartSyncingLine2 &&
	((optionsLine2 = {
		series: [
			{
...
var optionsArea,
	chartArea,
	chartSyncingArea = getChartColorsArray('chart-syncing-area')
chartSyncingArea &&
	((optionsArea = {
		series: [
			{
