...
forgotPassword = () => {
	...
	$.ajax({
		...
		success: (data) => {
			console.log(data)
			Swal.fire({
				html: '<div class="mt-3"><lord-icon src="https://cdn.lordicon.com/lupuorrc.json" trigger="loop" colors="primary:#0ab39c,secondary:#405189" style="width:120px;height:120px"></lord-icon><div class="mt-4 pt-2 fs-15"><h4>Well done!</h4><p class="text-muted mx-4 mb-0">Details of the reset password are sent in your email. You will be redirected in a second to the Login Page</p></div></div>',
				showCancelButton: !0,
				showConfirmButton: !1,
