$(function () {
	...
	$('#cancelAppointmentForm').submit((e) => {
		...
		// you can now use these values for further processing
		editGuidanceAppointmentStatus(cancel_appointment_id, cancel_consultation_status, cancel_remarks)
	})
	...
	$('#doneAppointmentForm').submit((e) => {
		...
		// you can now use these values for further processing
		editGuidanceAppointmentStatus(done_appointment_id, done_consultation_status, done_remarks)
	})
})
...
editGuidanceAppointmentStatus = (health_appointment_id, consultation_status, remarks) => {
	data = {
