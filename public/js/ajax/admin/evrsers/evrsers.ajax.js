$(function () {
	fetchForReviewTable()
	fetchForEvaluationTable()
	fetchForApprovalTable()
})
			...
			ajax: {
				...
				dataSrc: (result) => {
					...
					const filteredData = data.filter((item) => {
						return item.reserve_status == 'For Review'
					})
					return filteredData
				},
			},
		...
		dt.DataTable({
			...
			ajax: {
				...
				dataSrc: (result) => {
					const data = result.data
					const filteredData = data.filter((item) => {
						return item.reserve_status == 'For Evaluation / Processing'
					})
					return filteredData
				},
			},
		...
		dt.DataTable({
			...
			ajax: {
				...
				dataSrc: (result) => {
					const data = result.data
					const filteredData = data.filter((item) => {
						return item.reserve_status == 'Approved / Released'
					})
					return filteredData
				},
			},
