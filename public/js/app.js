!(function () {
	...
	function y(e) {
		document.getElementById('header-lang-img') &&
			('en' == e
				? (document.getElementById('header-lang-img').src = `${baseURL}public/images/flags/us.svg`)
				: 'sp' == e
				? (document.getElementById(
						'header-lang-img',
				  ).src = `${baseURL}public/images/flags/spain.svg`)
				: 'gr' == e
				? (document.getElementById(
						'header-lang-img',
				  ).src = `${baseURL}public/images/flags/germany.svg`)
				: 'it' == e
				? (document.getElementById(
						'header-lang-img',
				  ).src = `${baseURL}public/images/flags/italy.svg`)
				: 'ru' == e
				? (document.getElementById(
						'header-lang-img',
				  ).src = `${baseURL}public/images/flags/russia.svg`)
				: 'ch' == e
				? (document.getElementById(
						'header-lang-img',
				  ).src = `${baseURL}public/images/flags/china.svg`)
				: 'fr' == e &&
				  (document.getElementById(
						'header-lang-img',
				  ).src = `${baseURL}public/images/flags/french.svg`),
			localStorage.setItem('language', e),
			(b = localStorage.getItem('language')),
			(function () {
				null == b && y(g)
				var e = new XMLHttpRequest()
				e.open('GET', `${baseURL}public/lang/` + b + '.json'),
		...
		!a ||
			...
			((n =
				document.createElement(
					'ul',
				)).innerHTML = `<a href="#" class="logo"><img src="${baseURL}public/images/logo-sm.png" alt="" height="22"></a>`),
