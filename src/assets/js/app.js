...
;(function () {
	...
	function setLanguage(lang) {
		if (document.getElementById('header-lang-img')) {
			if (lang == 'en') {
				document.getElementById('header-lang-img').src = 'public/images/flags/us.svg'
			} else if (lang == 'sp') {
				document.getElementById('header-lang-img').src = 'public/images/flags/spain.svg'
			} else if (lang == 'gr') {
				document.getElementById('header-lang-img').src = 'public/images/flags/germany.svg'
			} else if (lang == 'it') {
				document.getElementById('header-lang-img').src = 'public/images/flags/italy.svg'
			} else if (lang == 'ru') {
				document.getElementById('header-lang-img').src = 'public/images/flags/russia.svg'
			} else if (lang == 'ch') {
				document.getElementById('header-lang-img').src = 'public/images/flags/china.svg'
			} else if (lang == 'fr') {
				document.getElementById('header-lang-img').src = 'public/images/flags/french.svg'
			}
	...
	function getLanguage() {
		...
		request.open('GET', 'public/lang/' + language + '.json')
	...
	function twoColumnMenuGenerate() {
		...
		if (
			defaultValues &&
			(isTwoColumn == 'twocolumn' || defaultValues['data-layout'] == 'twocolumn')
		) {
				...
				if (inputLength > 0) {
					...
					Array.from(notifyItem).forEach(function (element) {
						var notifiTxt = element.getElementsByTagName('span')
							? element.getElementsByTagName('span')[0].innerText.toLowerCase()
							: ''
	...
	function initTopbarComponents() {
		...
		if (document.getElementsByClassName('notification-check')) {
			Array.from(document.querySelectorAll('.notification-check input')).forEach(function (
				element,
			) {
