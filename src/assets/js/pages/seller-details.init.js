...
if (TableProductListAll) {
	new gridjs.Grid({
				...
				formatter: function (cell) {
					return gridjs.html(
						'<div class="d-flex align-items-center">' +
							...
							'<div class="avatar-sm bg-light rounded p-1"><img src="public/images/products/' +
							cell[0] +
		...
		data: [
			...
			[
				['img-3.png', '350 ml Glass Grocery Container', 'Kitchen Storage & Containers'],
				'10',
				'$ 25.00',
				'48',
				'4.5',
		...
		Array.from(counter).forEach(function (a) {
			!(function e() {
				var t = +a.getAttribute('data-target'),
					...
					o = t / speed
				o < 1 && (o = 1),
					n < t ? ((a.innerText = (n + o).toFixed(0)), setTimeout(e, 1)) : (a.innerText = t)
			})()
		})
}
