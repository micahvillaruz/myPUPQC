...
xhttp.onload = function () {
	...
	Array.from(json_records).forEach(function (raw) {
		...
		contactList.add({
			...
			date:
				formatDate(raw.date) + ' <small class="text-muted">' + timeConvert(raw.date) + '</small>',
...
xhttp.open('GET', 'public/json/contact-list.json')
xhttp.send()
...
function clearFields() {
	customerImg.src = 'public/images/users/user-dummy-img.jpg'
	customerNameField.value = ''
	company_nameField.value = ''
	designationField.value = ''
	email_idField.value = ''
