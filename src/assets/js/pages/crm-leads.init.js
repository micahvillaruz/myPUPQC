...
xhttp.open('GET', 'public/json/leads-list.json')
xhttp.send()
...
isCount = new DOMParser().parseFromString(leadsList.items.slice(-1)[0]._values.id, 'text/html')
...
function clearFields() {
	leadImg.src = 'public/images/users/user-dummy-img.jpg'
	leadNameField.value = ''
	company_nameField.value = ''
	dateField.value = ''
	leads_scoreField.value = ''
