...
xhttp.open('GET', 'public/json/company-list.json')
xhttp.send()

isCount = new DOMParser().parseFromString(companyList.items.slice(-1)[0]._values.id, 'text/html')
...
function clearFields() {
	companyLogoImg.src = 'public/images/users/multi-user.jpg'
	companyNameField.value = ''
	ownerField.value = ''
	industry_typeField.value = ''
	star_valueField.value = ''
