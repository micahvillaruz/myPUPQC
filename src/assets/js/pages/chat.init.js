...
var dummyUserImage = 'public/images/users/user-dummy-img.jpg'
var dummyMultiUserImage = 'public/images/users/multi-user.jpg'
...
var getChatList = function (chatid, chatItems) {
	...
	Array.from(newChatList.querySelectorAll('.copy-message')).forEach(function (subitem) {
		subitem.addEventListener('click', function () {
			var currentValue =
				newChatList.childNodes[1].firstElementChild.firstElementChild.firstElementChild
...
var emojiPicker = new FgEmojiPicker({
	...
	position: ['top', 'right'],
	preFetch: true,
	dir: 'public/js/pages/plugins/json',
