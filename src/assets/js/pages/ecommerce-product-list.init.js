...
var productListAllData = [
	{
		id: 1,
		product: {
			img: 'public/images/products/img-1.png',
	...
	},
	{
		id: 2,
		product: {
			img: 'public/images/products/img-2.png',
	...
	},
	{
		id: 3,
		product: {
			img: 'public/images/products/img-3.png',
	...
	},
	{
		id: 4,
		product: {
			img: 'public/images/products/img-4.png',
	...
	},
	{
		id: 5,
		product: {
			img: 'public/images/products/img-5.png',
	...
	},
	{
		id: 6,
		product: {
			img: 'public/images/products/img-6.png',
	...
	},
	{
		id: 7,
		product: {
			img: 'public/images/products/img-7.png',
	...
	},
	{
		id: 8,
		product: {
			img: 'public/images/products/img-8.png',
	...
	},
	{
		id: 9,
		product: {
			img: 'public/images/products/img-9.png',
	...
	},
	{
		id: 10,
		product: {
			img: 'public/images/products/img-10.png',
	...
	columns: [
			...
			data: function (row) {
				return gridjs.html(
					'<div class="d-flex align-items-center">' +
						...
						'<h5 class="fs-14 mb-1"><a href="apps-ecommerce-product-details.html" class="text-dark">' +
						row.product.title +
						'</a></h5>' +
		...
		},
		{
			...
			formatter: function (cell, row) {
				var x = new DOMParser()
					.parseFromString(row._cells[0].data.props.content, 'text/html')
				...
				return gridjs.html(
					'<div class="dropdown">' +
						...
						x +
						' href="apps-ecommerce-add-product.html"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>' +
	...
	Array.from(item.querySelectorAll('.form-check .form-check-input')).forEach(function (subitem) {
		...
		subitem.addEventListener('click', function (event) {
			if (subitem.checked) {
				...
				item.querySelector('.filter-badge').innerHTML = isFilterSelected
				isFilterSelected > 0
					? (item.querySelector('.filter-badge').style.display = 'block')
